...
var firebaseConfig = {
  apiKey: "AIzaSyARs75h_J3m8WU73vggq4xn_c1c6IFYStk",  // Твой Firebase API ключ
...
function analyzeFood() {
  ...
  reader.onloadend = function () {
    ...
    fetch('https://api.clarifai.com/v2/models/food-item-recognition/outputs', {
      method: 'POST',
      headers: {
        'Authorization': 'Key 10a38d2f1c934f129544e30dfd1a24b8', // Твой Clarifai API ключ
...
function getFatSecretToken() {
  return fetch('https://oauth.fatsecret.com/connect/token', {
    method: 'POST',
    headers: {
      'Authorization': 'Basic ' + btoa('98526599c876406ea4164afbe448d4fa:006f2301cdf3472a89ec1359f26e243e'), // Твои FatSecret Client ID и Client Secret
